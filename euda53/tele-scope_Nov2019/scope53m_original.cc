...
int main( int argc, char* argv[] )
{
  ...
  */ 
  ...
  string modfileA = "/eos/home-g/gennai/TestBeamAnalysis/2019/DESY_Nov/mod/run" + to_string(modrun) + "A.out"; // C++11
  ...
  string modfileB = "/eos/home-g/gennai/TestBeamAnalysis/2019/DESY_Nov/mod/run" + to_string(modrun) + "B.out";
  ...
  FileReader * reader;
  if(      run <    100 )
    reader = new FileReader( runnum.c_str(), "/eos/home-g/gennai/TestBeamAnalysis/2019/DESY_Nov/data/run0000$2R$X" );
  else if( run <   1000 )
    reader = new FileReader( runnum.c_str(), "/eos/home-g/gennai/TestBeamAnalysis/2019/DESY_Nov/data/run000$3R$X" );
  else if( run <  10000 )
    reader = new FileReader( runnum.c_str(), "/eos/home-g/gennai/TestBeamAnalysis/2019/DESY_Nov/data/run00$4R$X" );
  else if( run < 100000 )
    reader = new FileReader( runnum.c_str(), "/eos/home-g/gennai/TestBeamAnalysis/2019/DESY_Nov/data/run0$5R$X" );
  else
    reader = new FileReader( runnum.c_str(), "/eos/home-g/gennai/TestBeamAnalysis/2019/DESY_Nov/data/run$6R$X" );
